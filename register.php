...
require 'config/config.php';  // import the config PHP file
		...
		<div class="login_box">
			...
			<div id="first">
				<form action="register.php" method="POST">
					...
					<a href="#" id="signup" class="signup">Need a new account?</a>
			...
			<div id="second">
				<form action="register.php" method="POST">
					...
					<!-- use session variables to keep the values inside -->
					...
					?>" required>
					<br>
					<!-- check if the error message is in the error array, and echo it -->
					...
					<br>
					<?php if (in_array("Your password can only contain Englist characters or numbers<br>", $error_array)) echo "Your password can only contain Englist characters or numbers<br>";
